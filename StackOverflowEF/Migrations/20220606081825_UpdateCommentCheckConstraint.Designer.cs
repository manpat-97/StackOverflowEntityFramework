...
namespace StackOverflowEF.Migrations
{
    ...
    [Migration("20220606081825_UpdateCommentCheckConstraint")]
    partial class UpdateCommentCheckConstraint
    {
            ...
            modelBuilder.Entity("StackOverflowEF.Entities.Point", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_Points_AnswerId_QuestionId_NotBothNull", "[QuestionId] IS NOT NULL OR [AnswerId] IS NOT NULL");

...
namespace StackOverflowEF.Migrations
{
    ...
    [Migration("20220606083403_PointCheckConstraintUpdate")]
    partial class PointCheckConstraintUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StackOverflowEF.Entities.Comment", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_Comments_AnswerId_QuestionId_NotBothNull", "(([QuestionId] IS NULL OR [AnswerId] IS NULL) AND NOT ([QuestionId] IS NULL AND [AnswerId] IS NULL))");
            ...
            modelBuilder.Entity("StackOverflowEF.Entities.Point", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_Points_AnswerId_QuestionId_NotBothNull", "([QuestionId] IS NULL OR [AnswerId] IS NULL) AND NOT ([QuestionId] IS NULL AND [AnswerId IS NULL)");
            ...
            modelBuilder.Entity("StackOverflowEF.Entities.ViewModels.QuestionWithScore", b =>
                {
                    b.Property<string>("Content")
                        .HasColumnType("nvarchar(max)");
